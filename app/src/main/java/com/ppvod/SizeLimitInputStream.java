...
public class SizeLimitInputStream extends InputStream {
    ...
    /**
     * The input stream that is being protected. All methods should be forwarded to
     * it, after checking the size that has been read.
     *
    ...
    /**
     * The number of bytes that have been read from this stream. Read methods should
     * check to ensure that bytesRead never exceeds maxBytesToRead.
     *
     * @since ostermillerutils 1.04.00
     */
    ...
    /**
     * Tell whether the number of bytes specified in the constructor have been read
     * yet.
     *
    ...
    /**
     * Get the number of total bytes (including bytes already read) that can be read
     * from this stream (as set in the constructor).
     * 
     ...
     * @param maxBytesToRead the max number of bytes to allow to be read from the
     *                       underlying stream.
     *
     * @since ostermillerutils 1.04.00
     */
    ...
    /**
     * Close this stream and underlying streams. Calling this method may make data
     * on the underlying stream unavailable.
     * <p>
